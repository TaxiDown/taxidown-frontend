    ...
    <form className="mt-[-20] flex items-center justify-center" onSubmit={fetchData}>
        <div className="bg-white rounded-xl shadow p-6 w-120">
          ...
          <div className="flex gap-4 w-100 max-w-[90%]">
            ...
            <div className="text-[18px] text-green-700 font-bold w-full text-center">
            ...
            <Button className="w-full cursor-pointer text-white rounded-sm text-[17px] p-3 transition-transform duration-300 hover:scale-103 hover:bg-white hover:border-2 hover:border-black hover:text-black min-w-max" type="submit">Confirm Booking</Button>
          </div>
        </div>        
      </form>
    </>
