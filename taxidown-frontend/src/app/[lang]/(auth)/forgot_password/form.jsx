...
export default function ForgotClient({ dict, lang }) {
    ...
    >
      ...
      <div className="z-10 bg-white shadow-lg rounded-xl p-8 text-center max-w-md w-max py-13 pb-10 px-15 flex justify-center flex-col items-center gap-2">
        <h1 className="text-3xl font-bold mb-7">
          {dict.confirmPassword.reset}
        </h1>

        <div
          className={`input-wrapper flex-col ${
        ...
        >
          {dict.confirmPassword.sendReset}
        </button>
      </div>
    </form>
  );
